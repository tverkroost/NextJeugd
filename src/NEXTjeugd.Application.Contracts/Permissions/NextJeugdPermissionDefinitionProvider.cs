...
namespace NEXTjeugd.Permissions
{
    public class NEXTjeugdPermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            var adresPermission = myGroup.AddPermission(NEXTjeugdPermissions.Adressen.Default, L("Permission:Adressen"), MultiTenancySides.Tenant);
            adresPermission.AddChild(NEXTjeugdPermissions.Adressen.Create, L("Permission:Create"));
            adresPermission.AddChild(NEXTjeugdPermissions.Adressen.Edit, L("Permission:Edit"));
            adresPermission.AddChild(NEXTjeugdPermissions.Adressen.Delete, L("Permission:Delete"));
        }
